...
import { MapPin, Phone, Mail, MessageSquare, HeadphonesIcon } from "lucide-react"
...
const contactInfo = [
  ...
  },
  {
    icon: Mail,
    title: "Email Support",
    details: ["support@modernstore.com", "sales@modernstore.com", "Response within 24 hours"],
    action: "Send Email",
  },
]
            ...
            <div className="container px-4">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Have questions about our products or need assistance with your order? Our friendly support team is
          ...
          <section className="py-16">
            <div className="container px-4">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold mb-4">Choose Your Preferred Support</h2>
                    ...
                    <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                      <CardHeader>
                        <div className="relative">
                          ...
                          <Badge className="absolute -top-2 -right-8" variant="secondary">
                            {option.badge}
                          </Badge>
                        </div>
            ...
            <div className="container px-4">
              ...
              <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      We offer free standard shipping on orders over $50, with express and overnight options available.
                    </p>
                  </CardContent>
                </Card>
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      We accept returns within 30 days of purchase for a full refund, provided items are in original
                      condition.
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-muted-foreground">
                      Once your order ships, you'll receive a tracking number via email to monitor your package's
                      progress.
                    </p>
                  </CardContent>
                </Card>
